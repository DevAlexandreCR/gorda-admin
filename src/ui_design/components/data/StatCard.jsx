    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '0.75rem' }}>
        <div style={{
          ...
          letterSpacing: '0.02rem', color: 'var(--text-secondary)', lineHeight: 1.3,
        }}>{label}</div>
        {icon && (
          <div style={{
            width: '2.5rem', height: '2.5rem', flex: 'none',
            borderRadius: '0.7rem', background: GRAD[color] || GRAD.dark,
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
        ...
        {delta != null && (
          <span style={{ fontSize: '0.8rem', fontWeight: 700, color: deltaUp ? '#82d616' : '#ea0606', whiteSpace: 'nowrap' }}>
            {deltaUp ? '+' : ''}{delta}
          </span>
        )}
      </div>
